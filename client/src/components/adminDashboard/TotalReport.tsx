...
function TotalReport() {
  ...
  useEffect(() => {
    axiosInstance.get('/admin/totalreport')
      .then(response => {
  ...
  return (
    <div className="flex flex-wrap justify-center gap-8 p-4 bg-gray-100">
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 w-64 text-center">
        ...
        <div className="text-5xl font-semibold text-gray-800">{reportData.totalReportedPosts}</div>
