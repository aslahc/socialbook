...
const Post: React.FC<PostProps> = ({ post }) => {
  ...
  useEffect(() => {
    const postSaved = userData.savedPost.some((savedPost: any) => savedPost.post === post._id);
        ...
        {userData.savePostCategory.length > 0 ? (
          <div className="mb-4">
            ...
            >
              ...
              {userData.savePostCategory.map((category: string, index: number) => (
          ...
          <div className="flex flex-col items-center justify-center">
            <p className="text-gray-600 mb-4">You don't have any categories yet.</p>
            <button
              onClick={() => {
