...
function UserRouter() {
  ...
  return (
    <Routes>
      ...
      <Route
        path="/verifyEmail"
        element={auth ? <Navigate to="/home" /> : <Forgetpass />}
      />
      <Route
        path="/verifyEmailOtp"
        element={auth ? <Navigate to="/home" /> : <ForgetOtp />}
      />
      <Route
        path="/changepassword"
        element={auth ? <Navigate to="/home" /> : <Changepass />}
      />
      ...
      <Route
        ...
        element={auth ? <CompleteProfile /> : <Navigate to="/login" />}
      />
      ...
      <Route
        ...
        element={auth ? <UsersProfile /> : <Navigate to="/login" />}
      />
      <Route
        path="/chat"
      ...
      <Route
        ...
        element={auth ? <VideoCall /> : <Navigate to="/login" />}
      />
      <Route
        path="/explore"
        element={auth ? <Explore /> : <Navigate to="/login" />}
      />
      <Route
        path="/reel"
        element={auth ? <Reels /> : <Navigate to="/login" />}
      />

      <Route
        path="/Collections"
        element={auth ? <SavedPost /> : <Navigate to="/login" />}
      />
      <Route
        path="/Notification"
        element={auth ? <Notification /> : <Navigate to="/login" />}
      />
    </Routes>
  );
}
